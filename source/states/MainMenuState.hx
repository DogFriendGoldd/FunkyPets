...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Inicio", null);
		#end
		...
		var psychVer:FlxText = new FlxText(0, FlxG.height - 18, FlxG.width, "Pet Engine " + psychEngineVersion, 12);
		var fnfVer:FlxText = new FlxText(0, FlxG.height - 18, FlxG.width, 'v${funkinVersion} (PetSlice ${pSliceVersion})', 12);
