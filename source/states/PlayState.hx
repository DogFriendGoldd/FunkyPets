...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Sua rima é pessima!!', 0.2], //From 0% to 19%
		['Comeu Merda?!', 0.4], //From 20% to 39%
		['Noss Muito Ruim', 0.5], //From 40% to 49%
		['IXXX', 0.6], //From 50% to 59%
		['Eita', 0.69], //From 60% to 68%
		['NMeio Termo', 0.7], //69%
		['Bom', 0.8], //From 70% to 79%
		['Tranquilo Por Enquanto!', 0.9], //From 80% to 89%
		['Perfeito!!', 1], //From 90% to 99%
		['ANIMAL!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
